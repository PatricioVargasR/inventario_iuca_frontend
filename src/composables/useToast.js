...
function parseBackendError(errorData) {
  ...
  if (typeof raw === 'string') {
    if (raw.includes('unique constraint') || raw.includes('UniqueViolation') || raw.includes('duplicate key')) {
    ...
    if (raw.includes('not null') || raw.includes('NotNullViolation') || raw.includes('null value')) {
