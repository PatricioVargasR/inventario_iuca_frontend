...
export const TABS = [
  {
    ...
    label: "Áreas",
    labelSingular: "área",
    placeholder: "Ej: Dirección, Sistemas...",
  },
  {
    key: "estado",
    label: "Estados",
  ...
  },
  {
    ...
    labelSingular: "tipo de activo",
    placeholder: "Ej: Laptop, Escritorio...",
  },
  {
    key: "tipo_mobiliario",
    label: "Tipos de mobiliario",
    labelSingular: "tipo de mobiliario",
...
export const METODO_MAP = {
  ...
  tipo_activo: {
    getAll: "getTiposActivo",
    getOne: "getActivo",
    create: "createTipoActivo",
    update: "updateTipoActivo",
    delete: "deleteTipoActivo",
  },
  tipo_mobiliario: {
    getAll: "getTiposMobiliario",
    getOne: "getMobiliario",
    create: "createTipoMobiliario",
    update: "updateTipoMobiliario",
    delete: "deleteTipoMobiliario",
  },
};
